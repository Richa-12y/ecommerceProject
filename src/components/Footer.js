  ...
  return (
    <div className="mt-4">
      <footer className="p-6 dark:bg-gray-800 dark:text-gray-100">
        <div className="container grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-4">
          <div className="flex flex-col space-y-4">
            <h2 className="font-medium text-white hover:text-orange-500">
              Getting started
            </h2>
      ...
      <footer className="dark:bg-gray-800 dark:text-gray-50">
        <div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row divide-gray-400">
          <ul className="self-center py-6 space-y-4 text-center sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:flex-1 lg:justify-start">
            <li className=" text-white hover:text-orange-500">Shop</li>
            <li className=" text-white hover:text-orange-500">About</li>
            <li className=" text-white hover:text-orange-500">Blog</li>
            <li className=" text-white hover:text-orange-500">Pricing</li>
      ...
      <div className="flex items-center justify-center px-6 pt-12 text-sm">
        <span className="dark:text-gray-400 hover:text-orange-500">
